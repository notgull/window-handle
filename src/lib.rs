...
//! interface for windowing systems, it does not provide any guarantees
//! about the validity of the window handle. This creates a problem where
//! the window handle may be invalid, or may be inconsistent between
//! calls. This crate provides a safe interface for window handles that
//! can be used to ensure that the window handle is valid and consistent.
//!
